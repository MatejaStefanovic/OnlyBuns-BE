...
import org.onlybuns.service.LocationService;
...
public class PostController {
    ...
    @Autowired
    public PostController(PostService postService, MeterRegistry meterRegistry, LocationService locationService) {
    ...
    public ResponseEntity<Map<String, String>> createPost(@RequestPart("description") String description,
        ...
        createPostTimer.record(() -> {
            try {
                ...
                postService.createPost(new PostCreationDTO(description, image, locationData, email, false));
            } catch (IOException e) {
